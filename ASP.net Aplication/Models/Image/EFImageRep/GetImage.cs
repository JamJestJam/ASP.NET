...
namespace ASP.net_Aplication.Models.Image.EFImageRep {
    public partial class EFImageRep : IImageRep {
        public SchowModelImage GetImage(Int32 id, String userID) {
            SchowModelImage tmp = this.db.Images
                .Include(a => a.Author)
                .Include(a => a.Rates)
                ...
                .Select(a => new SchowModelImage() {
                    ...
                    Comments = a.Comments.Select(b => new ShowModelComment(b, userID))
                }).FirstOrDefault();
